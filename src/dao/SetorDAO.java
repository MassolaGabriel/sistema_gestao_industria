...
public class SetorDAO {
    ...
    public ArrayList<Setor> listar() {
        try {
            ...
            System.out.println("Faio em listar os clientes. " + e.getMessage());
        }
    ...
    public Boolean cadastrar(Setor setor) {
        try {
            ...
            System.out.println("Erro ao cadastrar no setor. " + e.getMessage());
        }
        return false;
    }
    ...
    public Boolean remover(Integer id) {
        try {
            ...
            System.out.println("Erro ao apagar o setor. " + e.getMessage());
        }
        return false;
    }
}
